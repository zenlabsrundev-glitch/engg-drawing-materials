  ...
  return (
    ...
    >
      <div className={`overflow-hidden bg-slate-100 transition-all duration-500 ease-in-out ${isFullView
        ...
        {/* Bottom Info Card */}
        <div className={`absolute bottom-5 left-5 right-5 z-40 pointer-events-none transition-all duration-500 ${isFullView ? 'opacity-0 translate-y-[100px]' : 'opacity-100 translate-y-0 max-w-lg mx-auto'}`}>
